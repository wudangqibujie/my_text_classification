...
class BertTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, do_lower_case=True, do_basic_tokenize=True, never_split=None,
                 unk_tokens="[UNK]", sep_token="[SEP]", pad_token="[PAD]", cls_token="[CLS]",
                 mask_token="[MASK]", tokenize_chinese_chars=True, **kwargs):
        super(BertTokenizer, self).__init__(unk_tokens=unk_tokens, sep_token=sep_token,
        ...
        self.wordpiece_tokenzier = WordpieceTokenizer(vocab=self.vocab, unk_token=self.unk_token)
    ...
    def _tokenize(self, text):
        ...
        if self.do_basic_tokenize:
            for token in self.basic_tokenizer.tokenize(text, never_split=self.all_special_tokens):
                for sub_token in self.wordpiece_tokenzier.tokenize(token):
                    split_tokens.append(sub_token)
        else:
            split_tokens = self.wordpiece_tokenzier.tokenize(text)
        return split_tokens
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        """
        if pretrained_model_name_or_path in PRETRAINED_POSITIONAL_EMBEDDING_SIZES:
...
if __name__ == '__main__':
    text = "①end-to-end tokenization: punctuation splitting + wordpiece 中国人 壹 Ⅰ"
