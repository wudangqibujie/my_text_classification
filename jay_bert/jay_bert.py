...
def gather_indexes(sequence_tensor, positions):
  ...
  flat_offsets = tf.reshape(
      debug, [-1, 1])
  print(f"positions: {positions.shape}, flat_offsets: {flat_offsets.shape}")
...
def input_fn_builder(input_files,
    ...
    def input_fn(params):
        ...
        if is_training:
            ...
            dataset = dataset.map(parse).shuffle(10).batch(batch_size).repeat(10)
...
train_input_fn = input_fn_builder(input_files,
                                  max_seq_length,
